...
public class HashCrypt {
    ...
    private static final int PBKDF2_ITERATIONS = PropertiesUtil.getPropertyAsInteger("security.properties", "password.encrypt.pbkdf2.iterations", 10000);
    ...
    public static String pbkdf2HashCrypt(String hashType, String salt, String value){
        ...
        try {
            ...
            sb.append(com.cornerstones.util.Base64.base64Encode(salt)).append("$");
            sb.append(new String(hash)).toString();
            return sb.toString();
        } catch (InvalidKeySpecException e) {
            throw new RuntimeException("Error while creating SecretKey", e);
        } catch (NoSuchAlgorithmException e) {
            throw new RuntimeException("Error while computing SecretKeyFactory", e);
        }
    }
    ...
    public static boolean doComparePbkdf2(String crypted, String password){
        try {
            ...
            byte[] salt = com.cornerstones.util.Base64.base64Decode(parts[1]).getBytes();
    ...
    private static String getSalt() {
        try {
            ...
            throw new RuntimeException("Error while creating salt", e);
        }
    }
    ...
    public static String digestHash(String hashType, String code, String str) {
        ...
        try {
            ...
            throw new RuntimeException("Error while computing hash of type " + hashType, e);
        }
    ...
    public static String getHashTypeFromPrefix(String hashString) {
        if (ValidateUtil.isEmpty(hashString) || hashString.charAt(0) != '{') {
            return null;
        }
    ...
    public static String digestHashOldFunnyHex(String hashType, String str) {
        if (ValidateUtil.isEmpty(hashType)) hashType = "SHA";
        if (str == null) return null;
        try {
            MessageDigest messagedigest = MessageDigest.getInstance(hashType);
