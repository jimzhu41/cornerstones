...
/**
 * AgreementPartyApplic generated by hbm2java
 */
@Entity
@Table(name = "AGREEMENT_PARTY_APPLIC", catalog = "ofbiz")
public class AgreementPartyApplic implements java.io.Serializable {

	private AgreementPartyApplicId id;
	...
	public AgreementPartyApplic(AgreementPartyApplicId id) {
		this.id = id;
	}

	public AgreementPartyApplic(AgreementPartyApplicId id, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	public AgreementPartyApplicId getId() {
		return this.id;
	}

	public void setId(AgreementPartyApplicId id) {
		this.id = id;
	}
