...
/**
 * AgreementAttribute generated by hbm2java
 */
@Entity
@Table(name = "AGREEMENT_ATTRIBUTE", catalog = "ofbiz")
public class AgreementAttribute implements java.io.Serializable {

	private AgreementAttributeId id;
	...
	public AgreementAttribute(AgreementAttributeId id) {
		this.id = id;
	}

	public AgreementAttribute(AgreementAttributeId id, String attrValue, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	public AgreementAttributeId getId() {
		return this.id;
	}

	public void setId(AgreementAttributeId id) {
		this.id = id;
	}
