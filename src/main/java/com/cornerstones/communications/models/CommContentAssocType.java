...
/**
 * CommContentAssocType generated by hbm2java
 */
@Entity
@Table(name = "COMM_CONTENT_ASSOC_TYPE", catalog = "ofbiz")
public class CommContentAssocType implements java.io.Serializable {
	...
	public CommContentAssocType(String commContentAssocTypeId, String description, Date lastUpdatedStamp,
	...
	@Column(name = "COMM_CONTENT_ASSOC_TYPE_ID", unique = true, nullable = false, length = 20)
