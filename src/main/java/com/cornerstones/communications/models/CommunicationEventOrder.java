...
/**
 * CommunicationEventOrder generated by hbm2java
 */
@Entity
@Table(name = "COMMUNICATION_EVENT_ORDER", catalog = "ofbiz")
public class CommunicationEventOrder implements java.io.Serializable {

	private CommunicationEventOrderId id;
	...
	public CommunicationEventOrder(CommunicationEventOrderId id) {
		this.id = id;
	}

	public CommunicationEventOrder(CommunicationEventOrderId id, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	public CommunicationEventOrderId getId() {
		return this.id;
	}

	public void setId(CommunicationEventOrderId id) {
		this.id = id;
	}
