...
/**
 * CommunicationEventProduct generated by hbm2java
 */
@Entity
@Table(name = "COMMUNICATION_EVENT_PRODUCT", catalog = "ofbiz")
public class CommunicationEventProduct implements java.io.Serializable {

	private CommunicationEventProductId id;
	...
	public CommunicationEventProduct(CommunicationEventProductId id) {
		this.id = id;
	}

	public CommunicationEventProduct(CommunicationEventProductId id, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	public CommunicationEventProductId getId() {
		return this.id;
	}

	public void setId(CommunicationEventProductId id) {
		this.id = id;
	}
