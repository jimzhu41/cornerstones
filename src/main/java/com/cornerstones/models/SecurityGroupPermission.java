...
/**
 * SecurityGroupPermission generated by hbm2java
 */
@Entity
@Table(name = "SECURITY_GROUP_PERMISSION", catalog = "ofbiz")
public class SecurityGroupPermission implements java.io.Serializable {
	...
	public SecurityGroupPermission(SecurityGroupPermissionId id, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "permissionId", column = @Column(name = "PERMISSION_ID", nullable = false, length = 60) ) })
