...
/**
 * PartyRelationshipType generated by hbm2java
 */
@Entity
@Table(name = "PARTY_RELATIONSHIP_TYPE", catalog = "ofbiz")
public class PartyRelationshipType implements java.io.Serializable {
	...
	public PartyRelationshipType(String partyRelationshipTypeId, String parentTypeId, Character hasTable,
			String partyRelationshipName, String description, String roleTypeIdValidFrom, String roleTypeIdValidTo,
	...
	@Column(name = "PARTY_RELATIONSHIP_TYPE_ID", unique = true, nullable = false, length = 20)
	...
	@Column(name = "PARTY_RELATIONSHIP_NAME", length = 100)
	...
	@Column(name = "ROLE_TYPE_ID_VALID_FROM", length = 20)
	...
	@Column(name = "ROLE_TYPE_ID_VALID_TO", length = 20)
