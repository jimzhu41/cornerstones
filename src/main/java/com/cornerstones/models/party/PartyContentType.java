...
/**
 * PartyContentType generated by hbm2java
 */
@Entity
@Table(name = "PARTY_CONTENT_TYPE", catalog = "ofbiz")
public class PartyContentType implements java.io.Serializable {
	...
	public PartyContentType(String partyContentTypeId, String parentTypeId, String description, Date lastUpdatedStamp,
	...
	@Column(name = "PARTY_CONTENT_TYPE_ID", unique = true, nullable = false, length = 20)
