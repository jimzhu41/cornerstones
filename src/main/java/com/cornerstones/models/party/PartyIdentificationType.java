...
/**
 * PartyIdentificationType generated by hbm2java
 */
@Entity
@Table(name = "PARTY_IDENTIFICATION_TYPE", catalog = "ofbiz")
public class PartyIdentificationType implements java.io.Serializable {
	...
	public PartyIdentificationType(String partyIdentificationTypeId) {
		this.partyIdentificationTypeId = partyIdentificationTypeId;
	}

	public PartyIdentificationType(String partyIdentificationTypeId, String parentTypeId, Character hasTable,
	...
	@Column(name = "PARTY_IDENTIFICATION_TYPE_ID", unique = true, nullable = false, length = 20)
