...
/**
 * PartyContactMechPurpose generated by hbm2java
 */
@Entity
@Table(name = "PARTY_CONTACT_MECH_PURPOSE", catalog = "ofbiz")
public class PartyContactMechPurpose implements java.io.Serializable {

	private PartyContactMechPurposeId id;
	...
	public PartyContactMechPurpose(PartyContactMechPurposeId id) {
		this.id = id;
	}

	public PartyContactMechPurpose(PartyContactMechPurposeId id, Date thruDate, Date lastUpdatedStamp,
	...
	public PartyContactMechPurposeId getId() {
		return this.id;
	}

	public void setId(PartyContactMechPurposeId id) {
		this.id = id;
	}
