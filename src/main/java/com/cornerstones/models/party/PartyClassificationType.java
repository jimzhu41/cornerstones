...
/**
 * PartyClassificationType generated by hbm2java
 */
@Entity
@Table(name = "PARTY_CLASSIFICATION_TYPE", catalog = "ofbiz")
public class PartyClassificationType implements java.io.Serializable {
	...
	public PartyClassificationType(String partyClassificationTypeId, String parentTypeId, Character hasTable,
	...
	@Column(name = "PARTY_CLASSIFICATION_TYPE_ID", unique = true, nullable = false, length = 20)
