...
/**
 * PartyContent generated by hbm2java
 */
@Entity
@Table(name = "PARTY_CONTENT", catalog = "ofbiz")
public class PartyContent implements java.io.Serializable {

	private PartyContentId id;
	...
	public PartyContent(PartyContentId id) {
		this.id = id;
	}

	public PartyContent(PartyContentId id, Date thruDate, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "partyContentTypeId", column = @Column(name = "PARTY_CONTENT_TYPE_ID", nullable = false, length = 20) ),
			@AttributeOverride(name = "fromDate", column = @Column(name = "FROM_DATE", nullable = false, length = 19) ) })
	public PartyContentId getId() {
		return this.id;
	}

	public void setId(PartyContentId id) {
		this.id = id;
	}
