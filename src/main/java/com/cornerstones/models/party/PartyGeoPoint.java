...
/**
 * PartyGeoPoint generated by hbm2java
 */
@Entity
@Table(name = "PARTY_GEO_POINT", catalog = "ofbiz")
public class PartyGeoPoint implements java.io.Serializable {

	private PartyGeoPointId id;
	...
	public PartyGeoPoint(PartyGeoPointId id) {
		this.id = id;
	}

	public PartyGeoPoint(PartyGeoPointId id, Date thruDate, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "geoPointId", column = @Column(name = "GEO_POINT_ID", nullable = false, length = 20) ),
			@AttributeOverride(name = "fromDate", column = @Column(name = "FROM_DATE", nullable = false, length = 19) ) })
	public PartyGeoPointId getId() {
		return this.id;
	}

	public void setId(PartyGeoPointId id) {
		this.id = id;
	}
