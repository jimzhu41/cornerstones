...
/**
 * PartyClassification generated by hbm2java
 */
@Entity
@Table(name = "PARTY_CLASSIFICATION", catalog = "ofbiz")
public class PartyClassification implements java.io.Serializable {
	...
	public PartyClassification(PartyClassificationId id) {
		this.id = id;
	}

	public PartyClassification(PartyClassificationId id, Date thruDate, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "partyClassificationGroupId", column = @Column(name = "PARTY_CLASSIFICATION_GROUP_ID", nullable = false, length = 20) ),
