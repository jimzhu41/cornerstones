...
/**
 * UserLoginPasswordHistoryId generated by hbm2java
 */
@Embeddable
public class UserLoginPasswordHistoryId implements java.io.Serializable {
	...
	public UserLoginPasswordHistoryId(String userLoginId, Date fromDate) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UserLoginPasswordHistoryId))
			return false;
