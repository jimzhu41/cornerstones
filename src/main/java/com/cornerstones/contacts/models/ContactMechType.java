...
/**
 * ContactMechType generated by hbm2java
 */
@Entity
@Table(name = "CONTACT_MECH_TYPE", catalog = "ofbiz")
public class ContactMechType implements java.io.Serializable {
	...
	public ContactMechType(String contactMechTypeId, String parentTypeId, Character hasTable, String description,
	...
	@Column(name = "CONTACT_MECH_TYPE_ID", unique = true, nullable = false, length = 20)
