...
/**
 * ContactMechAttribute generated by hbm2java
 */
@Entity
@Table(name = "CONTACT_MECH_ATTRIBUTE", catalog = "ofbiz")
public class ContactMechAttribute implements java.io.Serializable {

	private ContactMechAttributeId id;
	...
	public ContactMechAttribute(ContactMechAttributeId id) {
		this.id = id;
	}

	public ContactMechAttribute(ContactMechAttributeId id, String attrValue, Date lastUpdatedStamp,
	...
	public ContactMechAttributeId getId() {
		return this.id;
	}

	public void setId(ContactMechAttributeId id) {
		this.id = id;
	}
