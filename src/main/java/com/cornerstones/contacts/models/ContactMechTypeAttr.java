...
/**
 * ContactMechTypeAttr generated by hbm2java
 */
@Entity
@Table(name = "CONTACT_MECH_TYPE_ATTR", catalog = "ofbiz")
public class ContactMechTypeAttr implements java.io.Serializable {

	private ContactMechTypeAttrId id;
	...
	public ContactMechTypeAttr(ContactMechTypeAttrId id) {
		this.id = id;
	}

	public ContactMechTypeAttr(ContactMechTypeAttrId id, Date lastUpdatedStamp, Date lastUpdatedTxStamp,
	...
	public ContactMechTypeAttrId getId() {
		return this.id;
	}

	public void setId(ContactMechTypeAttrId id) {
		this.id = id;
	}
